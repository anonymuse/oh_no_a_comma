# CLAUDE.md — ats-location-canonicalization

Read this file before touching anything. It is the complete context for this
coding session. The project has scaffolding in place; your job is to bring it
...
## Suggested planning mode sequence

Use plan mode before writing any code. Work through these prompts in order:
